...
public class ProductImageServlet extends BaseBackServlet{
	...
	public String add(HttpServletRequest request, HttpServletResponse response, Page page) {
        ...
        p.setType(type);
        p.setProduct(productDAO.get(pid));
        productImageDAO.add(p);
        String fileName = p.getId()+ ".jpg";
        String imageFolder;
        String imageFolder_small=null;
        String imageFolder_middle=null;
        if(ProductImageDAO.type_single.equals(p.getType())){
	...
	public String delete(HttpServletRequest request, HttpServletResponse response, Page page) {
		...
		if(productImageDAO.type_single.equals(pi.getType())) {
			String imageFolder = request.getSession().getServletContext().getRealPath("img/productSingle");
			...
			File f_single = new File(imageFolder, pi.getId()+".jpg");
			f_single.delete();
			...
			File f_detail = new File(imageFolder, pi.getId()+".jpg");
			f_detail.delete();
		}
