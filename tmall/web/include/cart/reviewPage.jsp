...
$(function(){
$("button.orderListItemReview").click(function(){
		var oid = $(this).attr("oid");
		var params = "";
		$(".makereview").each(function(){
		...
		for(x=0;x<content.length;x++){
			content[x].value=encodeURI(encodeURI(content[x].value));
			params += "&content="+ content[x].value ;
			
		}
		
			
		
		location.href="foredoreview?oid="+oid+params;
	});	
});
		...
		<form method="post" >
			...
			<table class="makeReviewTable">
				<tr>
					...
					<td class="makereview" pid="${p.id}"><textarea class="makereview2"  name="content" ></textarea></td>
				</tr>
			</table>
...
<div class="makeReviewButtonDiv">
				...
				<button oid="${o.id}" class="orderListItemReview" type="submit">提交评价</button>
			</div>
			</c:if>
</div>
